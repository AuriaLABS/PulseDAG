...
- [ ] Peer diagnostics evidence from `/p2p/status` and `/p2p/peers`, including peer count, peer ids, connection state, chain id, P2P mode, local node id, last known peer activity when available, and sync/tip summary.
