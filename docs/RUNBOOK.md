...
| `PULSEDAG_RPC_CORS_ALLOWLIST` | explicit origins | CORS `*` is always rejected. `PULSEDAG_RPC_CORS_UNSAFE_ALLOW_WILDCARD_WITH_ADMIN` is parsed but unused and does not override the ban (#1129). |
