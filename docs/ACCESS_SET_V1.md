...
- `A.writes ∩ B.reads ≠ ∅`
- `B.writes ∩ A.reads ≠ ∅`
- `A.write_keys ∩ B.write_keys ≠ ∅`
- `A.write_keys ∩ B.read_keys ≠ ∅`
- `B.write_keys ∩ A.read_keys ≠ ∅`
...
- Under-declare spend → reject.
- Permuted arrival of the same block body → identical accepted set and state digest.
