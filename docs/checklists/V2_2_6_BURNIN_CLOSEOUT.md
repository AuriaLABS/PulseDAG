# v2.2.6 burn-in closeout checklist

Use this checklist after the 14-day burn-in to formally close out `v2.2.6` release readiness.
...
8. **Release + ops sign-off captured in `dry-run/go-no-go.md`?** If yes, **GO** to finalize `v2.2.6` closeout.
