# v2.2.2 burn-in closeout checklist

Use this checklist after the 14-day burn-in to decide whether to tag `v2.2.2`.
...
5. **Release + ops sign-off captured?** If yes, **GO** to tag `v2.2.2`.
