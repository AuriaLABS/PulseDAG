...
case "$GATE" in
  5n1m|5N1M|5n/1m|5N/1M)
    SCRIPT="scripts/v2_2_19_private_5n_1m_rehearsal.sh"
    DEFAULT_OUT="artifacts/v2_2_19/private_5n_1m_rehearsal"
    ;;
  5n2m|5N2M|5n/2m|5N/2M)
    SCRIPT="scripts/v2_2_19_private_5n_2m_rehearsal.sh"
    DEFAULT_OUT="artifacts/v2_2_19/private_5n_2m_rehearsal"
    ;;
  5n4m|5N4M|5n/4m|5N/4M|stress)
    SCRIPT="scripts/v2_2_19_private_5n_4m_rehearsal.sh"
    DEFAULT_OUT="artifacts/v2_2_19/private_5n_4m_rehearsal"
    ;;
  *)
...
echo "docker_v2_2_19_rehearsal gate=$GATE"
echo "script=$SCRIPT"
