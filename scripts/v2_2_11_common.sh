...
STATE_DIR="${PULSEDAG_REHEARSAL_STATE_DIR:-$ROOT_DIR/.pulsedag-v2_2_11-rehearsal}"
LOG_DIR="${PULSEDAG_REHEARSAL_LOG_DIR:-$STATE_DIR/logs}"
DATA_ROOT="${PULSEDAG_REHEARSAL_DATA_ROOT:-$STATE_DIR/data}"
CHAIN_ID="${PULSEDAG_REHEARSAL_CHAIN_ID:-pulsedag-rehearsal-v2-2-11}"
...
node_bootnode_a() { echo "${PULSEDAG_NODE_A_BOOTNODE:-/ip4/127.0.0.1/tcp/18181}"; }
...
stop_all_v2_2_11() { stop_miner_a; stop_node c; stop_node b; stop_node a; }
