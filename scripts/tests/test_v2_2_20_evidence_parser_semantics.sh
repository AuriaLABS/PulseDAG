...
grep_q 'parse_miner_terminal_evidence' "$SCRIPT"
grep_q 'miner_evidence_parser.awk' "$SCRIPT"
grep_q 'local_miner_templates_received' "$SCRIPT"
grep_q 'unique_submitted_block_hashes' "$SCRIPT"
grep_q 'node_block_duplicate_events_total' "$SCRIPT"
grep_q 'evidence_consistency_failures' "$SCRIPT"
grep_q 'MINER_EVIDENCE_CONSISTENCY' "$SCRIPT"

grep_q 'failure_classes_json' "$SCRIPT"
grep_q 'primary_failure_class' "$SCRIPT"
grep_q 'sync_observability_incomplete' "$SCRIPT"
grep_q 'canonical_node_gap' "$SCRIPT"
grep_q 'harness_observed_gap' "$SCRIPT"
