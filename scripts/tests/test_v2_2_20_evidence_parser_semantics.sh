...
grep_q 'rpc_liveness' "$SCRIPT"
grep_q 'sync_orphan' "$SCRIPT"
grep_q 'network_counters' "$SCRIPT"
grep_q 'metric_definitions' "$SCRIPT"
grep_q 'distinct_tips' "$SCRIPT"
grep_q 'worst_lag_from_max_height' "$SCRIPT"
grep_q 'orphan_recovery_classification_counters' "$SCRIPT"
grep_q 'prior_evidence:\{gate_c' "$SCRIPT"
