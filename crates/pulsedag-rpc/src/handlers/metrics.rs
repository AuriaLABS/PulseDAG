...
pub struct MetricsData {
    ...
    pub mempool_capacity_max: usize,
    pub mempool_spent_outpoints: usize,
    pub mempool_spent_outpoints_capacity_max: usize,
    pub mempool_admit_total: u64,
    pub mempool_reject_total: u64,
    pub mempool_confirmed_removed_total: u64,
    ...
    pub selected_tip_mismatch: bool,
...
pub async fn get_metrics<S: RpcStateLike>(
    ...
    Json(ApiResponse::ok(MetricsData {
        ...
        mempool_capacity_max: chain.mempool.max_transactions,
        mempool_spent_outpoints: chain.mempool.spent_outpoints.len(),
        mempool_spent_outpoints_capacity_max: chain.mempool.max_spent_outpoints,
        mempool_admit_total: chain.mempool.counters.accepted_total,
        mempool_reject_total: chain.mempool.counters.rejected_total,
        mempool_confirmed_removed_total: chain.mempool.counters.confirmed_removed_total,
        ...
        selected_segment_uncorrelated_headers_total: runtime
            .selected_segment_uncorrelated_headers_total,
        active_session_id: runtime.active_session_id,
        active_session_peer: runtime.active_session_peer.clone(),
        active_session_remote_tip: runtime.active_session_remote_tip.clone(),
        active_session_remote_height: runtime.active_session_remote_height,
        active_session_common_ancestor: runtime.active_session_common_ancestor.clone(),
        active_session_requested_headers: runtime.active_session_requested_headers,
        active_session_received_headers: runtime.active_session_received_headers,
        active_session_requested_blocks: runtime.active_session_requested_blocks,
        active_session_received_blocks: runtime.active_session_received_blocks,
        active_session_applied_blocks: runtime.active_session_applied_blocks,
        active_session_remaining_blocks: runtime.active_session_remaining_blocks,
        ...
        network_selected_height_gap: canonical_sync.network_selected_height_gap,
        storage_replay_gap: canonical_sync.storage_replay_gap,
        selected_tip_mismatch: canonical_sync.network_selected_tip_mismatch,
        live_sync_error_active: canonical_sync.live_sync_error_active,
        live_sync_error_cleared_total: canonical_sync.live_sync_error_cleared_total,
        stale_sync_error_suppressed_total: canonical_sync.stale_sync_error_suppressed_total,
        canonical_remote_tip_generation: canonical_sync.canonical_remote_tip_generation,
        canonical_remote_tip_peer: canonical_sync.canonical_remote_tip_peer,
        limitations: vec![
