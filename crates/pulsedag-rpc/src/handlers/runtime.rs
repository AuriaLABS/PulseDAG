...
pub struct RuntimeStatusData {
    ...
    pub dropped_p2p_txs_mempool_full: u64,
    pub rejected_rpc_txs_mempool_full: u64,
...
pub async fn get_runtime_status<S: RpcStateLike>(
    ...
    Json(ApiResponse::ok(RuntimeStatusData {
        ...
        dropped_p2p_txs_mempool_full: runtime.dropped_p2p_txs_mempool_full,
        rejected_rpc_txs_mempool_full: runtime.rejected_rpc_txs_mempool_full,
        ...
        mempool_max_txs: runtime.mempool_max_txs,
