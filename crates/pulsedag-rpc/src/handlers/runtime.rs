...
pub struct RuntimeStatusData {
    ...
    pub p2p_peer_message_rate_limited_count: u64,
    pub p2p_peer_effective_count: usize,
    pub p2p_peer_min_target_missed_total: u64,
    pub p2p_peer_cooldown_bypassed_for_connectivity_total: u64,
    pub p2p_peer_rate_limit_recovery_suppressed_total: u64,
    pub p2p_peer_rate_limit_by_kind_total: BTreeMap<String, u64>,
    pub p2p_peer_suppressed_dial_count: u64,
    ...
    pub p2p_tx_inbound_received: usize,
    pub p2p_tx_inbound_accepted: usize,
    pub p2p_tx_inbound_duplicate: usize,
    pub p2p_tx_inbound_invalid: usize,
    pub p2p_tx_relayed: usize,
    pub p2p_tx_relay_suppressed_budget: usize,
    pub p2p_tx_relay_suppressed_duplicate: usize,
...
struct RuntimeP2pRecoverySummary {
    ...
    message_rate_limited_count: u64,
    suppressed_dial_count: u64,
    ...
    tx_relayed: usize,
    tx_relay_suppressed_budget: usize,
    tx_relay_suppressed_duplicate: usize,
...
pub async fn get_runtime_status<S: RpcStateLike>(
    ...
    let p2p_recovery = state
        ...
        .map(|status| {
            ...
            RuntimeP2pRecoverySummary {
                ...
                tx_inbound_received: status.tx_inbound_received,
                tx_inbound_accepted: status.tx_inbound_accepted,
                tx_inbound_duplicate: status.tx_inbound_duplicate,
                tx_inbound_invalid: status.tx_inbound_invalid,
                tx_relayed: status.tx_relayed,
                tx_relay_suppressed_budget: status.tx_relay_suppressed_budget,
                tx_relay_suppressed_duplicate: status.tx_relay_suppressed_duplicate,
    ...
    Json(ApiResponse::ok(RuntimeStatusData {
        ...
        external_mining_last_invalid_pow_reason: runtime
            ...
            .clone(),
        external_mining_submit_inflight: runtime.external_mining_submit_inflight,
        external_mining_submit_started_total: runtime.external_mining_submit_started_total,
        external_mining_submit_completed_total: runtime.external_mining_submit_completed_total,
        external_mining_submit_timeout_total: runtime.external_mining_submit_timeout_total,
        ...
        external_mining_submit_lock_wait_ms: runtime.external_mining_submit_lock_wait_ms,
        external_mining_submit_accept_ms: runtime.external_mining_submit_accept_ms,
        external_mining_submit_post_accept_ms: runtime.external_mining_submit_post_accept_ms,
        external_mining_submit_total,
        pulsedag_blocks_accepted_total: runtime.pulsedag_blocks_accepted_total,
        pulsedag_blocks_rejected_total: runtime.pulsedag_blocks_rejected_total,
        pulsedag_invalid_pow_total: runtime.pulsedag_invalid_pow_total,
        pulsedag_mining_templates_total: runtime.pulsedag_mining_templates_total,
        pulsedag_mining_submits_total: runtime.pulsedag_mining_submits_total,
        pulsedag_p2p_blocks_received_total: runtime.pulsedag_p2p_blocks_received_total,
        pulsedag_sync_missing_parents_total: runtime.pulsedag_sync_missing_parents_total,
        ...
        p2p_peer_message_rate_limited_count: p2p_recovery.message_rate_limited_count,
        p2p_peer_effective_count: 0,
        p2p_peer_min_target_missed_total: 0,
        p2p_peer_cooldown_bypassed_for_connectivity_total: 0,
        p2p_peer_rate_limit_recovery_suppressed_total: 0,
        p2p_peer_rate_limit_by_kind_total: Default::default(),
        p2p_peer_suppressed_dial_count: p2p_recovery.suppressed_dial_count,
        ...
        p2p_tx_inbound_received: p2p_recovery.tx_inbound_received,
        p2p_tx_inbound_accepted: p2p_recovery.tx_inbound_accepted,
        p2p_tx_inbound_duplicate: p2p_recovery.tx_inbound_duplicate,
        p2p_tx_inbound_invalid: p2p_recovery.tx_inbound_invalid,
        p2p_tx_relayed: p2p_recovery.tx_relayed,
        p2p_tx_relay_suppressed_budget: p2p_recovery.tx_relay_suppressed_budget,
        p2p_tx_relay_suppressed_duplicate: p2p_recovery.tx_relay_suppressed_duplicate,
...
mod tests {
    ...
    async fn runtime_status_surfaces_p2p_mode_and_peer_health_summary() {
        ...
        let p2p_status = P2pStatus {
            ...
            peer_known_connected_total: 0,
            peer_known_disconnected_total: 0,
            peer_known_cooldown_total: 0,
            peer_known_rate_limited_total: 0,
            peer_known_dialable_total: 0,
