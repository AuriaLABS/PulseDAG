...
fn sync_status_from_rpc_snapshot(snapshot: NodeRpcSnapshot) -> SyncStatusData {
    ...
    SyncStatusData {
        ...
        missing_parent_request_started_total: 0,
        missing_parent_request_already_pending_total: 0,
        ...
        missing_parent_peer_not_found_total: 0,
        ...
        local_selected_height: snapshot.height,
        best_remote_selected_height: None,
        best_remote_selected_tip: None,
        live_sync_error_active: 0,
        live_sync_error_cleared_total: 0,
        stale_sync_error_suppressed_total: 0,
        canonical_remote_tip_generation: 0,
        canonical_remote_tip_peer: None,
        sync_live_error: None,
        sync_last_historical_error: None,
        sync_last_error_resolved_at: None,
        sync_last_error_resolution_reason: None,
    }
}
...
pub async fn get_sync_status<S: RpcStateLike>(
    ...
    let data = SyncStatusData {
        ...
        network_selected_tip_mismatch: canonical_sync.network_selected_tip_mismatch,
        storage_replay_gap: canonical_sync.storage_replay_gap,
        storage_memory_mismatch: canonical_sync.storage_memory_mismatch,
        local_selected_height: canonical_sync.local_selected_height,
        best_remote_selected_height: canonical_sync.best_remote_selected_height,
        best_remote_selected_tip: canonical_sync.best_remote_selected_tip,
        ...
        sync_live_error: canonical_sync.sync_live_error,
        sync_last_historical_error: canonical_sync.sync_last_historical_error,
        sync_last_error_resolved_at: canonical_sync.sync_last_error_resolved_at,
        sync_last_error_resolution_reason: canonical_sync.sync_last_error_resolution_reason,
        ...
        missing_parent_peer_not_found_total: runtime.missing_parent_peer_not_found_total,
        missing_parent_peer_timeout_total: runtime.missing_parent_peer_timeout_total,
