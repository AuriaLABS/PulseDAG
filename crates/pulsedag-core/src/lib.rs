...
pub use monetary_v3::{
    ...
    COINBASE_MATURITY_NS, COINBASE_MATURITY_SECONDS, CONSENSUS_BURN_BPS, ECONOMIC_YEAR_NS,
    ECONOMIC_YEAR_SECONDS, GENESIS_ISSUANCE_ATOMS, MAX_SUPPLY_ATOMS,
    MONETARY_CADENCE_FINGERPRINT_DOMAIN_V3, MONETARY_POLICY_CANONICAL_V3,
    MONETARY_POLICY_FINGERPRINT_V3, MONETARY_POLICY_VERSION_V3, ORDINARY_FEE_RECIPIENT_BPS,
    TAIL_EMISSION_ATOMS, TERMINAL_ECONOMIC_YEAR, YEAR1_MINING_BUDGET_ATOMS,
};
pub use protocol::{
