...
pub use monetary_v3::{
    ...
    GENESIS_ISSUANCE_ATOMS, HALF_LIFE_QUANTA, HALF_LIFE_SECONDS, MAX_SUPPLY_ATOMS,
    ...
    Q64_ONE, TAIL_EMISSION_ATOMS, TERMINAL_EMISSION_QUANTUM, TERMINAL_EMISSION_SECONDS,
